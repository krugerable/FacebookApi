...
public class WebBrowserHelper
{
    ...
    public extern static IntPtr FindFirstUrlCacheGroup(int dwFlags, int dwFilter, IntPtr lpSearchCondition, int dwSearchCondition, ref long lpGroupId, IntPtr lpReserved);
    ...
    public extern static bool FindNextUrlCacheGroup(IntPtr hFind, ref long lpGroupId, IntPtr lpReserved);
    ...
    public extern static bool DeleteUrlCacheGroup(long GroupId, int dwFlags, IntPtr lpReserved);
    ...
    public extern static IntPtr FindFirstUrlCacheEntry([MarshalAs(UnmanagedType.LPTStr)] string lpszUrlSearchPattern, IntPtr lpFirstCacheEntryInfo, ref int lpdwFirstCacheEntryInfoBufferSize);
    ...
    public extern static bool FindNextUrlCacheEntry(IntPtr hFind, IntPtr lpNextCacheEntryInfo, ref int lpdwNextCacheEntryInfoBufferSize);
    ...
    public extern static bool DeleteUrlCacheEntry(IntPtr lpszUrlName);
    #endregion
            ...
            if (enumHandle != IntPtr.Zero)
            {
                ...
                do
                {
                    ...
                    if (!more && Marshal.GetLastWin32Error() == ERROR_INSUFFICIENT_BUFFER)
                    {
                        ...
                        cacheEntryInfoBuffer = Marshal.ReAllocHGlobal(cacheEntryInfoBuffer, new IntPtr(cacheEntryInfoBufferSize));
                        more = FindNextUrlCacheEntry(enumHandle, cacheEntryInfoBuffer, ref cacheEntryInfoBufferSizeInitial);
                    }
                } while (more);
            }
